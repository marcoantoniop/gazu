...
class Captcha {
  ...
  function draw ($output=1, $width=300, $height=100, $fontsize=24, $font="imagenes/arial.ttf") {
    // (B1) OOPS.
    $font = __DIR__ . "/brisk.ttf";
    ...
    $background = "imagenes/captcha-back.jpg";
  ...
  function verify ($check) {
    // (C1) CAPTCHA NOT SET!
    if (!isset($_SESSION['captcha'])) { throw new Exception("CAPTCHA ERROR"); }
