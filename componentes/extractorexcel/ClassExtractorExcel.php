<?php
    ...
    class ClassExtractorExcel
    {
        ...
        function leer_carpeta($carpeta, $id, $ruta) {
            ...
            $localArray[0] = ["id" => 0, "icono" => "ico", "archivo" => "", "tipo_archivo" => "xlsx", "carpeta" =>
                $carpeta];
            $leercarpeta = $ruta . "/";
            $contador = 0;
        ...
        function crearXmlArchivos(){
            ...
            */
            ...
            $nombre_archivo = "bloques/leer_excel/archivos.xml";
        ...
        function crearXmlCarpetas(){
            ...
            */
            ...
            $nombre_archivo = "bloques/leer_excel/carpetas.xml";
