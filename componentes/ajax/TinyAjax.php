...
class TinyAjax
{
	 ...
	 * Coloca el url para llamar con la petici�n de t�cnica de venta de recuperaci�n.
	 *
	 ...
	 * Ejecuta la llamada a la funci�n si la p�gina es cargada en modo-llamada
	 */
     ...
     *
     * 890/5000
     * Exporta una funci�n para llamar en php llamando a la funci�n javascript crea una llamada asincr�nica a la funci�n php.
     * Si no se especifica sourceId, debe proporcionar par�metros a la funci�n; de lo contrario, se generar�n stubs para recuperar autom�ticamente los valores de los elementos fuente.
     * Si se especifica la devoluci�n de llamada, llamar� a esa funci�n, de lo contrario, los comportamientos especifican lo que ocurre en el lado del cliente.
     * Si el par�metro de devoluci�n de llamada tiene como prefijo un #, entonces ese elemento obtiene el valor devuelto, establece el valor si el elemento lo admite, de lo contrario establece innerhtml.
     * @param string $ functionName Funci�n para exportar
     * @param array / string $ aSourceId, array o cadena que contiene id para obtener el valor, si se establece como nulo, entonces usted debe proporcionar los par�metros de devoluci�n de llamada usted mismo
     * @param string $ callback si se establece, entonces, funci�n de javascript de devoluci�n de llamada personalizada, no se usaron comportamientos
     * @param obj $ callback si se establece, entonces la funci�n se llama en esta clase
	 * 
